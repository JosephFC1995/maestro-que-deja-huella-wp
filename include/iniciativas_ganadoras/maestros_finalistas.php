<div class="__switcher__tab maestros_finalistas">
    <div uk-grid>
        <div class="uk-width-1-3@m">
             <div class="__select_custom__move d-md-none d-block" id="select_ccc_e" data_content="maestros_finalista">
            ...
            <ul class="uk-tab-left" uk-tab="connect: #componente_maestros_finalistas; animation: uk-animation-slide-top-small, uk-animation-slide-bottom-small">
                <?php for ($i=(date('Y') - 1); $i > 2006; $i--) {  ?>
                    <li class="d-none d-md-block"><a href="#"><span class="fecha">Edicion <?php echo $i; ?> </span> <span class="ico"><i class="arrow right"></i></span></a></li>
                <?php } ?>
            </ul>
        </div>
        <div class="uk-width-expand@m">
            <ul id="componente_maestros_finalistas" class="uk-switcher" data_content_content="maestros_finalista">
                         ...
                         <div class="__content_separate uk-position-relative">
                            ...
                            <div class="row __row">
                                ...
                                <?php $valid_no_exist = true; ?>
                                 ...
                                 <?php if ( $query_maestro_finalista->have_posts() ) : ?>

                                    <?php while ( $query_maestro_finalista->have_posts() ) : $query_maestro_finalista->the_post(); ?>
