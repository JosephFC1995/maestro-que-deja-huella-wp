<?php $banner = get_field('banner', $__id_from_page) ?>
<section class="banner__pages d-none d-md-flex" id="banner__pages" style="background-image: url(<?php echo $banner['imagen'] ?>);">
